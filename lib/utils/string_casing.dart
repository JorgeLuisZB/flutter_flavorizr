...
extension StringReCase on String {
  String get camelCase => StringCasing(this).camelCase;

  String get constantCase => StringCasing(this).constantCase;

  String get sentenceCase => StringCasing(this).sentenceCase;

  String get snakeCase => StringCasing(this).snakeCase;

  String get dotCase => StringCasing(this).dotCase;

  String get paramCase => StringCasing(this).paramCase;

  String get pathCase => StringCasing(this).pathCase;

  String get pascalCase => StringCasing(this).pascalCase;

  String get headerCase => StringCasing(this).headerCase;

  String get titleCase => StringCasing(this).titleCase;
}